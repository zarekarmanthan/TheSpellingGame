...
public class UI_FriendsDisplay : MonoBehaviour
{
    [SerializeField] private Transform friendContainer;
    [SerializeField] private UI_Friend uiFriendPrefab;
    ...
    private void HandleDisplayFriends(List<FriendInfo> friends)
    {
        ...
        {
            UI_Friend uifriend = Instantiate(uiFriendPrefab, friendContainer);
